      ...
      <u-form class="form" :model="form" ref="form" :rules="rules">
            ...
            >
              <template slot="suffix">
                <text class="suffix-text"
                  >RMB (参考价：{{ rateData.rate }} RMB)</text
                >
              </template>
            </u-input>
          </view>
        ...
        <u-form-item prop="amount" borderBottom>
          <view class="item">
            ...
            >
              <template slot="suffix">
                <text class="suffix-text">RMB</text>
              </template>
            </u-input>
          </view>
        </u-form-item>
      ...
      <view class="order-promo">
        <view class="flex-box-between">
          <view class="flex-box">
            ...
            <view class="promo-price">0手续费，瞬间成交</view>
          </view>
        ...
        <view
          v-for="(item, index) in tradeList"
          :key="index"
          class="order-info flex-box-between"
        >
