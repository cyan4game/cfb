<template>
  <view class="page">
    ...
    <view class="page-box">
      ...
      <u-button class="page-box-btn" color="#505bde" text="离开" @click="exit"></u-button>
    </view>
    <u-image class="page-logo" width="320rpx" height="128rpx" src="/static/icons/logo.svg"></u-image>
  </view>
</template>
