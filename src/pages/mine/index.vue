...
<template>
    <view class="page-mine">
        ...
        <view class="page-content">
           ...
           <!-- 选项 -->
           <view class="navs">
                <view class="nav" v-for="item in navs" :key="item.key" @click="navClick(item)">
                    <u-image class="icon" :src="item.icon" width="40rpx" height="40rpx"></u-image>
                    ...
                    <u-image class="icon" src="/static/images/mine/right.png" width="15rpx" height="30rpx"></u-image>
                </view>
           </view>
        </view>
...
export default {
    data() {
        return {
            tabs: [
                { key: 1, name: '资金明细', icon: '/static/images/mine/tab-1.png', route: '/pages/funds/index' },
