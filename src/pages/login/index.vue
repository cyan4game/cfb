<template>
  <view class="main-page">
    ...
    <view class="login-box">
      ...
      <text style="color: #F98905;font-size: 28rpx;margin: 55rpx auto 0 auto;display: block;text-align: center;position: relative;top:-20rpx" @click="router('pages/customer/index')" >接收不到短信？</text>
    </view>
